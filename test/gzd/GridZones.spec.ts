...
describe('GridZones Tests', function () {
  ...
  it('test zone numbers', function () {
    ...
    for (
      ...
      const west = longitude > MGRSConstants.MIN_LON && longitude < MGRSConstants.MAX_LON ? zoneNumber - 1 : zoneNumber;
  ...
  it('test band letters', function () {
    ...
    for (
      ...
      let south =
        latitude > MGRSConstants.MIN_LAT && latitude < 80.0 ? MGRSUtils.previousBandLetter(bandLetter) : bandLetter;
